...
export const projects = [
  {
    ...
    period: '2024 – Present',
    summary:
      'An AI agent platform designed to help small businesses and individuals automate real work with practical, accessible tools.',
    highlights: [
  ...
  },
  {
    ...
    period: '2024 – Present',
    summary:
      'Hands-on specialization in robotic-assisted surgery — bridging clinical teams, technology, and adoption.',
    highlights: [
...
export const testimonials = [
  {
    quote:
      'Jack brings rare clarity to complex technology. He connects clinical needs with the right solution and follows through in high-pressure environments.',
    attribution: 'Healthcare Partner',
    context: 'Robotic surgery program support',
  },
  {
    quote:
      'He thinks in systems, asks sharp questions, and turns ideas into action. Jack is the kind of person you want driving a new initiative.',
